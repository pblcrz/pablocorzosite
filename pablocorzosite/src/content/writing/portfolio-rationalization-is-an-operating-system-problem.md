---
title: "Portfolio Rationalization Is an Operating System Problem"
number: 20
kind: "Article"
...
relationships:
  - target: "the-decision-that-could-wait"
    type: "builds-on"
    note: >
      Turns the entry/continuation asymmetry into a prescription: if
      accumulation is produced by the operating model, that is where the fix
      has to live.
---

We already established in ['The Portfolio Nobody Designed'](/writing/the-portfolio-nobody-designed) that filling a garage happens almost without noticing. Cleaning the garage is different.
