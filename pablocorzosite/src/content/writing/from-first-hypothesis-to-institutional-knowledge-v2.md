...
## Self-diagnostic: find where you actually are

Leaders rarely lack a pillar entirely. Far more often they hold a partial version of the capability and mistake the partial state for the whole. The table below is a mirror. Find the row that describes your organization honestly, and it will usually point to the pillar you have been under-investing in.

| State | What it looks like | Tell-tale symptom |
| :---- | :---- | :---- |
| Platform only | Sophisticated tooling, no governed lifecycle, little adoption beyond a few experts. | High license spend, low experiment velocity, results nobody acts on. |
| Program only | Heavy process, weak tooling, thin buy-in. | Experiments take forever; teams route around the process; "governance" means delay. |
| Culture only | Strong appetite, no infrastructure or discipline. | Many tests, contradictory conclusions, no memory; the same question re-litigated each quarter. |
| Platform + Program, no Culture | A well-run machine a central team operates for others. | Experimentation scales in the owning team and nowhere else; it never becomes "how we think." |
| Platform + Culture, no Program | Enthusiastic and well-tooled, but ungoverned. | Quality varies wildly; no prioritization; the portfolio is whatever people felt like testing. |
| Program + Culture, no Platform | Disciplined and motivated, but slow and error-prone. | Manual analysis, contested results, eroding trust despite good intentions. |
| **All three** | The center. | From first hypothesis to institutional knowledge - experiments that compound. |
